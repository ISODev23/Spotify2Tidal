...
class Spotify2Tidal:
    ...
    Parameters
    ----------
    tidal_session_file: str
        Path to the file used to persist the Tidal OAuth session
    ...
    def __init__(
        ...
        self.tidal = Tidal(tidal_session_file)
    ...
    def copy_discover_weekly(self, playlist_name="Discover Weekly", progress_callback=None):
        ...
        progress_callback: callable, optional
            Called with (current, total, artist, track_name) after each track.
        """
        self._add_spotify_playlist_to_tidal(
    ...
    def _add_spotify_playlist_to_tidal(
        ...
        for current_track, track in enumerate(spotify_tracks, start=1):
            ...
            if progress_callback:
                progress_callback(current_track, total_tracks, artist, name)
